        ...
        <footer className="footer footer-center p-10 bg-black text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    <span className='text-4xl'>ResaleBD</span> <br />Address: Level-2, 28, Ahsan Bag,<br /> Kamrangirchar, Dhaka-1211
                </p>
                <p className='text-sm'><small className="text-white-50">Privacy Ploicy | Terms of use</small></p>
